...
for dataset1 in ['COD10K','CHAMELEON','CAMO','NC4K']:
    FM = M.Fmeasure()
    WFM = M.WeightedFmeasure()
    SM = M.Smeasure()
    EM = M.Emeasure()
    MAE = M.MAE()
    mask_root = r'/home/zbq/MSCAF-COD-master/TestDataset/{}/GT/'.format(dataset1)
    pred_root = r'/home/zbq/second_innovate/MSCAFNet_Third_FP_CBAM/results_80_lr/{}/'.format(dataset1)
