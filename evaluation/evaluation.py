...
mask_root = '/home/zbq/part_TestDataset/CHAMELEON/cover/GT/'
pred_root = '/home/zbq/errnet_improve_2/results_improve_mutiScale/CHAMELEON/cover/'
...
with open("../resultImproveMultiScale.txt", "a+") as f:
    print('CHAMELEON_COVER:',
          'Smeasure:', sm.round(3), '; ',
          'meanEm:', '-' if em['curve'] is None else em['curve'].mean().round(3), '; ',
          'wFmeasure:', wfm.round(3), '; ',
          'MAE:', mae.round(3), '; ',
